...
class CertificateValidation {
    ...
    create = z.object({
        body: z.object({
            hod: z.string({ required_error: "HOD ID is required" }),
            external: z.string({ required_error: "External ID is required" }),
    ...
    // Validation schema for updating an existing certificate
    update = z.object({
        params: z.object({
    ...
    // Validation schema for fetching certificates with filters
    show = z.object({
        query: z.object({
            department: z
    ...
    // Validation schema for deleting a certificate
    delete = z.object({
        params: z.object({
            certificateId: z.string({ required_error: "Certificate ID is required" }),
        }),
